...
// SQL-Befehl für SSH-Terminal nach Befehl "mysql"
// CREATE USER 'balancebot'@'localhost' IDENTIFIED BY 'BalanceBotPasswort';GRANT USAGE ON *.* TO 'balancebot'@'localhost' REQUIRE NONE WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;CREATE DATABASE IF NOT EXISTS `balancebot`;GRANT ALL PRIVILEGES ON `balancebot`.* TO 'balancebot'@'localhost';
